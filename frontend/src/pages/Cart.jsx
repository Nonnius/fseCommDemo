...
const Cart = () => {
  ...
  useEffect(() =>{
    ...
    //console.log(tempData); trigger test only!!!
      ...
      <div className='flex justify-end my-20'>
        <div className='w-full sm:w-[450px]'>
          ...
          <div className='w-full text-center'>
            ...
            className='bg-black rounded text-white text-sm my-8 px-8 py-3 cursor-pointer'>
              PROCEED TO CHECKOUT
            </button>
          </div>
        </div>
